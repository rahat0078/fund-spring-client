    ...
    <div>
      ...
      <div className="w-full md:w-10/12 mx-auto my-16 px-4">
        <div className="text-center mb-12">
          ...
          <p className="lg:w-2/3 md:w-3/4 w-full mx-auto text-center mt-6 text-gray-400">Step into action with campaigns that are shaping a brighter future. Your support fuels progress, hope, and transformation. Explore these ongoing opportunities to make an impact today.</p>
        </div>
